      ...
      <ProSidebar collapsed={isCollapsed}>
        <Menu iconShape="square">
          ...
          {!isCollapsed && (
            <Box mb="25px">
              ...
              <Box textAlign="center">
                ...
                <Typography varriant="h5" color={colors.greenAccent[500]}>
                  React jr dev - admin
                </Typography>
              </Box>
            </Box>
          ...
          <Box paddingLeft={isCollapsed ? undefined : "10%"}>
            ...
            <Item title="Invoice Balances" to="/invoices" icon={<ReceiptOutlinedIcon />} selected={selected} setSelected={setSelected} />
            <Typography variant="h6" color={colors.grey[300]} sx={{ m: "15px 0 5px 20px" }}>
              Pages
            </Typography>
